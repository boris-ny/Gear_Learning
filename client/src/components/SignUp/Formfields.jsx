...
FormFields.propTypes = {
  ...
  secretquestion: PropTypes.shape({
    value: PropTypes.string.isRequired,
    onChange: PropTypes.func.isRequired,
  }).isRequired,
  secretanswer: PropTypes.shape({
    value: PropTypes.string.isRequired,
    onChange: PropTypes.func.isRequired,
  }).isRequired,
};
    ...
    <div>
      ...
      <div className="form-group mt-4">
        ...
        <input
          ...
          required
          value={country.value}
          onChange={country.onChange}></input>
        <div className="valid-feedback"></div>
        <div className="invalid-feedback">* Must be filled.</div>
      </div>
      <div className="form-group mt-4">
        ...
        <input
          ...
          required
          value={address.value}
          onChange={address.onChange}></input>
        <div className="valid-feedback"></div>
        <div className="invalid-feedback">* Must be filled.</div>
      </div>
      <div className="form-group mt-4">
        ...
        <input
          ...
          required
          value={mobile.value}
          onChange={mobile.onChange}></input>
        <div className="valid-feedback"></div>
        <div className="invalid-feedback">* Must be filled.</div>
      </div>
      <div className="form-group mt-4">
        ...
        <input
          ...
          onChange={secretquestion.onChange}></input>
        <div className="valid-feedback"></div>
        <div className="invalid-feedback">* Must be filled.</div>
      </div>
      <div className="form-group mt-4">
        ...
        <input
          ...
          onChange={secretanswer.onChange}></input>
        <div className="valid-feedback"></div>
        <div className="invalid-feedback">* Must be filled.</div>
      </div>
    </div>
